...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 16, 2024 lúc 04:45 PM
...
--
-- Cơ sở dữ liệu: `db_recruitment_system`
--
...
INSERT INTO `job` (`jobid`, `UploadFeaturedImage`, `JobTitle`, `JobRegion`, `Gender`, `JobType`, `education`, `other_benifits`, `publishedon`, `Responsibilities`, `experience`, `salary`, `application_deadline`, `email`, `location`, `job_description`, `job_id_detail`, `status`, `user_id`, `CompanyName`, `UploadLogo`) VALUES
...
(5, 'tải xuống.png', 'dxgh', 'Anywhere', 'Female', 'Full Time', 'rthrte', 'rdtyu', '2024-01-13', 'sgd', '4', 4, '2024-01-05', 'ttsp24020gtrgr34@gmail.com', 'retyh', 'sadf', '', 0, 0, '4', 'tải xuống.png');
