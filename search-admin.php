...
$query_search = "select jobid,UploadLogo,JobTitle,CompanyName,JobRegion,JobType from job where status = 0 ";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { ?>
        <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href=<?php echo !empty($_SESSION['fullname']) ? "job-single-admin.php?jobid=".$row["jobid"]:"login.html"?>></a>
