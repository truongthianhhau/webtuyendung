...
if (isset($_POST['updateForm'])) {
  if (!empty($_POST['Pass'])) {
    ...
    $query_updateProfile->bind_param("sssssiss", $_POST['fullName'], $_POST['Phone'], $fileurl, $_POST['Address'], $_POST['Birthday'], $Gender, $_POST['Pass'], $_SESSION['email']);
                ...
                <div class="card-body p-4">
                  ...
                  <div class="row pt-1">
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <input style="margin-left: 10px;" type="radio" name="Gender" value="2" <?php if ($row['Gender'] == "2") echo 'checked="checked"'; ?>> Female
